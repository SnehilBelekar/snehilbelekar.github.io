...
const resumeData: ResumeData = {
  ...
  sections: [
    ...
    // Positionnement: Architecte de Plateforme | DevSecOps | Conformité & Gouvernance
    {
      title: 'Résumé',
      type: 'text',
      content: `• Architecte de plateforme stratégique et axé sur la sécurité, avec 15+ ans d'expérience dans la conception de zones d'atterrissage cloud multi-clouds et l'application de principes de sécurité par conception (secure-by-design) dans les SDLC complexes.
