...
const resumeData: ResumeData = {
  ...
  sections: [
    ...
    // Positionering: Platformarchitect | DevSecOps | Compliance & Governance
    {
      title: 'Samenvatting',
      type: 'text',
      content: `Strategische, beveiligingsgerichte technisch architect met 15+ jaar ervaring in het ontwerpen van multi-cloud bedrijfslandingszones en het toepassen van secure-by-design-principes in complexe SDLC.
