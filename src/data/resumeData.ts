...
const resumeData: ResumeData = {
  ...
  sections: [
    ...
    // Positioning: Platform Architect | DevSecOps | Compliance & Governance
    {
      title: 'Summary',
      type: 'text',
      content: `Strategic, security-focused Technical Architect with 15+ years designing multi-cloud enterprise landing zones and driving secure-by-design principles across complex SDLC.
